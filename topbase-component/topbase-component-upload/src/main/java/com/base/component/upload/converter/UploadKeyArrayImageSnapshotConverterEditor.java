 ...
 * @author start 
 */
public class UploadKeyArrayImageSnapshotConverterEditor extends BaseArgsStringArrayConverterEditor {

	private String args;
	
	public UploadKeyArrayImageSnapshotConverterEditor(Class<?> prototype) {
		super(prototype);
	}
	...
	public Object getSource() {
		...
		for(int i=0;i<array.length();i++) {
			Array.set(arrays, i, service.getImageSnapshotUrl(array.getString(i),width,height));
		}
		return arrays;
	}
